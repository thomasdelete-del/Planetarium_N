...
/* Die Mondtextur ist eine erdfeste Vorderseitenkarte. Sie darf nicht mit dem
   Positionswinkel der hellen Sichel rotieren. Dieser Winkel gehört nur zur
   Beleuchtung. Da der Zeichenkontext für den Terminator bereits gedreht ist,
   wird die Oberflächenkarte beim Einzeichnen exakt gegengedreht. */
function drawMoonSurfaceFixed(ctx,image,mx,my,r,brightLimbAng){
  ctx.save();ctx.translate(mx,my);ctx.rotate(-brightLimbAng);ctx.translate(-mx,-my);
